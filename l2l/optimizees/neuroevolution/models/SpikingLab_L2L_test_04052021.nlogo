...
to write_log [ #filename #log_data ]
  file-close-all
  file-open #filename
  file-print #log_data
  file-flush
...
to go
 ...
 if ticks >= 10000 [
    ...
    let result_file (word "individual_result_" simulation_index ".csv" )
    write_l2l_results result_file
    stop
 ]
 let log_str ( word "I am running step: " ticks )
 if ticks mod 500 = 0 [ write_log "individual_log.log" log_str ]
...
<experiments>
  <experiment name="experiment1" repetitions="1" runMetricsEveryStep="true">
    ...
    <enumeratedValueSet variable="test_variable">
      <value value="1"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
