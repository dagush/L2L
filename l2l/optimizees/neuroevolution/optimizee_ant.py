...
NeuroEvolutionOptimizeeAntParameters = namedtuple(
    'NeuroEvoOptimizeeAntParameters', ['path', 'seed', 'n_generation'])
...
class NeuroEvolutionOptimizeeAnt(Optimizee):
    def __init__(self, traj, parameters):
        ...
        print(os.path.join(str(fp), 'config_ant.json'))
        with open(
                os.path.join(str(fp), 'config_ant.json')) as jsonfile:
    ...
    def create_individual(self):
        ...
        weights = self.rng.uniform(-20, 20, 78)
