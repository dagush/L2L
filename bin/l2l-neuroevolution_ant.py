...
from l2l.optimizees.neuroevolution import NeuroEvolutionOptimizeeAnt, NeuroEvolutionOptimizeeAntParameters
...
def run_experiment():
    ...
    # Optimizee params
    optimizee_parameters = NeuroEvolutionOptimizeeAntParameters(
        path=experiment.root_dir_path, seed=1, n_generation=10)
    optimizee = NeuroEvolutionOptimizeeAnt(traj, optimizee_parameters)
